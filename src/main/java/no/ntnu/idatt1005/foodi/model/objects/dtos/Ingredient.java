...
public class Ingredient {
  ...
  public boolean equals(Object o) {
    // Automatically generated by IntelliJ IDEA
    if (this == o) {
      return true;
    }
  ...
  public enum Unit {
    ...
    Unit(@NotNull String databaseKey, @NotNull String name) {
      this.name = name;
  ...
  public enum Category {
    ...
    Category(@NotNull String databaseKey, @NotNull String name, @NotNull String icon) {
      this.databaseKey = databaseKey;
      this.name = name;
      this.icon = icon;
    }
