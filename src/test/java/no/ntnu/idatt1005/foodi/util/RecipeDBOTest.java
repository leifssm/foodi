...
public class RecipeDBOTest {
  ...
  public static void setUp() throws SQLException {
    ...
    testRecipe = new Recipe(1, "Pasta", "Pasta with tomato sauce", Recipe.Difficulty.EASY, Recipe.DietaryTag.VEGETARIAN,30, "https://www.example.com", "https://www.example.com");
    testRecipe2 = new Recipe(2, "Pizza", "Pizza with tomato sauce and cheese", Recipe.Difficulty.EASY, Recipe.DietaryTag.VEGETARIAN, 45, "https://www.example.com", "https://www.example.com");
  }
